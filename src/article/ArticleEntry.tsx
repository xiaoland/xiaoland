...
export default function ArticleEntry({
  ...
  return (
    ...
    >
      <div
        className="basis-0 border-2 border-sys-border-strong border-solid box-border flex flex-col gap-3 grow h-full pb-6 pl-3 pr-6 pt-3 color-sys-text-primary"
        data-node-id="201:90"
      >
        <span className="relative shrink-0 text-3xl" data-node-id="201:77">
          {title}
        </span>
        <span className="min-w-full relative text-lg color-sys-text-secondary" data-node-id="201:141">
          {description}
        </span>
      </div>
      <div
        className="flex flex-col font-mono items-end relative color-sys-text-tertiary text-lg"
