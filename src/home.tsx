...
export function Home() {
  ...
  return (
    <div className="bg-comp-home-bg relative min-h-screen box-border px-[1.5rem] py-[2rem] md:pl-[3rem] md:pr-[2rem] md:py-[3rem] flex flex-col md:flex-row gap-[2rem] md:gap-[4rem]">
      <div className="flex flex-shrink-0 flex-col justify-between">
        {/* Intro */}
        <div className="flex flex-col">
          <span className="color-comp-home-text font-size-[1.25rem] md:font-size-[1.5rem]">你好👋，我是</span>
          {/* Handle */}
        ...
        {/* Tags */}
        <div className="flex flex-col text-[1.5rem] md:text-[2rem] color-comp-home-tags font-mono mt-[1.5rem] md:mt-0">
          <span>Pythonist</span>
          <span>Vuer</span>
          <span>Homelaber</span>
        </div>
